    ...
    <main className="w-full min-h-screen flex flex-col items-center">
      ...
      <section className="w-full max-w-5xl px-6 py-20 flex flex-col items-center text-center">
        ...
        <p className="text-lg opacity-80 max-w-2xl mb-10">
          Transformamos sua rotina de estudos com cronogramas inteligentes, foco
          no que realmente cai e suporte de quem entende o caminho da aprovação.
        </p>
      ...
      <section className="py-20 px-6 text-center">
        <div className="card card-interactive max-w-3xl mx-auto border border-(--accent)">
          ...
          <p className="mb-8 opacity-90">
            Junte-se a milhares de alunos que estão simplificando a jornada para
            a universidade.
          </p>
      ...
      <footer className="py-10 opacity-60 text-sm">
