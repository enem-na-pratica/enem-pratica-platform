...
export function StudyTrackerClient({ subjects, targetUsername }: PageProps) {
  ...
  const handleStatusChange = async (
    ...
    const updatedProgress = await updateTopicStatus({
      topicId,
      status: newStatus,
      targetUsername,
    });
    ...
    setTopics((prev) =>
      prev.map((tp) =>
        tp.topic.id === topicId
          ? {
              ...tp,
              progress: updatedProgress, // Aqui vem o ID real, authorId real, etc.
            }
          : tp,
      ),
    );
